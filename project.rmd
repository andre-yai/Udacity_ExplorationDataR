...
In my dataset there are ... values with ... features (quality, residual.sugar,sulphate,fixed.acid,t).
...
We can see that as alcohol increases there are less density.
...
In this plot woucan see that as the quality increases there are more alcohol at higher levels and lower densities.
